...
CREATE OR REPLACE PROCEDURE dodaj_adres(a_Ulica VARCHAR2, a_Nr_Domu NUMBER, a_Miasto VARCHAR2, a_Kod_Pocztowy VARCHAR2) AS BEGIN
INSERT INTO Adres (Adres_ID, Ulica, Nr_Domu, Miasto, Kod_Pocztowy)
VALUES (Adres_seq.nextval, a_Ulica, a_Nr_Domu, a_Miasto, a_Kod_Pocztowy);
END;
/
...
VALUES(RECEPTA_SEQ.nextval,a_Pracownik_ID,a_Klient_ID,a_Data_wystawienia);
END;
/

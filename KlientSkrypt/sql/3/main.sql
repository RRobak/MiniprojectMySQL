...
EXECUTE dodaj_adres( 'Warszawska', 2, 'Kielce', '25-126');

EXECUTE dodaj_adres( 'Wisniowa', 5, 'Wloszczowa', '29-100');

EXECUTE dodaj_adres( 'Krakowska', 26, 'Kielce', '25-126');

EXECUTE dodaj_adres( 'Jagiellonska', 15, 'Kielce', '25-126');

EXECUTE dodaj_adres( 'Partyzantow', 110, 'Wloszczowa', '29-100');

EXECUTE dodaj_adres('Szkolna', 20, 'Krasocin', '29-105');

EXECUTE dodaj_adres( 'Radomska', 91, 'Krasocin', '29-105');

EXECUTE dodaj_adres( 'Swietokrzyska', 22, 'Kielce', '25-126');

EXECUTE dodaj_adres( 'Niepodleglosci', 39, 'Warszawa', '02-344');

EXECUTE dodaj_adres('Towarowa', 1, 'Warszawa', '02-344');

EXECUTE dodaj_adres( 'Fabryczna', 40, 'Lublin', '20-010');

EXECUTE dodaj_adres( 'Podlaska', 76, 'Lublin', '20-010');
...
EXECUTE dodaj_klient( 'Jakub', 'Bordolinski',55, 3);
...
EXECUTE dodaj_recepta(2,1,TO_DATE('09-APR-19'));

EXECUTE dodaj_recepta(3,2,TO_DATE('03-MAY-19'));

EXECUTE dodaj_recepta(4,3,TO_DATE('04-JUN-19'));

EXECUTE dodaj_recepta(6,4,TO_DATE('10-JUL-19'));

EXECUTE dodaj_recepta(7,5,TO_DATE('12-MAY-19'));

EXECUTE dodaj_recepta(1,6,TO_DATE('28-FEB-19'));

EXECUTE dodaj_recepta(1,7,TO_DATE('30-MAY-19'));
